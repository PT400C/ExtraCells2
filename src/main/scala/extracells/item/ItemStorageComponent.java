...
public class ItemStorageComponent extends ItemECBase implements IStorageComponent {
	...
	private IIcon[] icons;
	public final String[] suffixes = { "physical.256k", "physical.1024k", "physical.4096k", "physical.16384k", "physical.65536k", "physical.262144k", "physical.1048576k", "fluid.1k", "fluid.4k", "fluid.16k", "fluid.64k", "fluid.256k", "fluid.1024k", "fluid.4096k", "gas.1k", "gas.4k", "gas.16k", "gas.64k", "gas.256k", "gas.1024k", "gas.4096k" };
	public final int[] size = new int[] { 262144, 1048576, 4194304, 16777216, 67108864, 268435456, 1073741824,
